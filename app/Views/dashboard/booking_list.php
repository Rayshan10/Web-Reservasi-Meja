              ...
              <table class="table table-bordered datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= esc($booking['telepon']) ?></td>
                    <td><?= esc($booking['tanggal']) ?></td>
                    <td><?= esc($booking['waktu']) ?></td>
                    <td><?= esc($booking['jumlah_tamu']) ?></td>
                    <td><?= esc($booking['meja_id']) ?></td>
                    <td>
                    ...
                    <td>
                      <a href="<?= site_url('booking/edit/'.$booking['id']) ?>" class="btn btn-sm btn-primary">Edit</a>
                      <a href="<?= site_url('booking/delete/'.$booking['id']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
                </tbody>
